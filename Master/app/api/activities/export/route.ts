...
import { exportActivitiesToCSV } from '@/modules/activities/service'
import { activityFilterSchema, activitySortSchema } from '@/modules/activities/schemas'
...
export async function GET(request: NextRequest) {
  try {
    ...
    const csv = await exportActivitiesToCSV(authContext.userId, authContext.role, processedFilters, sortOptions)
    ...
    const message = error instanceof Error ? error.message : 'Failed to export activities'
